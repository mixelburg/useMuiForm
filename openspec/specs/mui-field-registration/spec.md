# mui-field-registration

## Purpose

The `register` adapter wires react-hook-form field state into MUI inputs, returning the props (including change/blur event handlers) that an MUI input spreads to stay in sync with RHF.
